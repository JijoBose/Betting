...
class TeamMatchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create team_match" do
    assert_difference('TeamMatch.count') do
      post team_matches_url, params: { team_match: { match_id: @team_match.match_id, score: @team_match.score, team_id: @team_match.team_id } }
    end
  ...
  test "should update team_match" do
    patch team_match_url(@team_match), params: { team_match: { match_id: @team_match.match_id, score: @team_match.score, team_id: @team_match.team_id } }
