...
class PayoutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payout" do
    assert_difference('Payout.count') do
      post payouts_url, params: { payout: { amount: @payout.amount, match_id: @payout.match_id, type: @payout.type, user_id: @payout.user_id } }
    end
  ...
  test "should update payout" do
    patch payout_url(@payout), params: { payout: { amount: @payout.amount, match_id: @payout.match_id, type: @payout.type, user_id: @payout.user_id } }
